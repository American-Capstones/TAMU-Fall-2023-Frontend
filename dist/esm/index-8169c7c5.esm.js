...
import { Progress, ResponseErrorPanel, Table, Page, Header, HeaderLabel, Content, ContentHeader, SupportButton, InfoCard } from '@backstage/core-components';
...
const DenseTable = ({ users }) => {
  ...
  const data = users.map((user) => {
    return {
      avatar: /* @__PURE__ */ React.createElement("img", { src: user.picture, className: classes.avatar, alt: user.name.first }),
